...
public class BrowserStackSampleLocal {
  ...
  public static String userName = "nihalagazade_JxPH1i";
  public static String accessKey = "4y5LkQnzzGkv2s7ERZ4q";
  ...
  public static void tearDownLocal() throws Exception {
	...
	public static void main(String[] args) throws Exception {
      ...
      DesiredCapabilities capabilities = new DesiredCapabilities();
    	...
    	capabilities.setCapability("app", "bs://85fc746d084cefd52320f2da61e1f79dd9f37fa6");
